<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="update.aspx.cs" Inherits="practice.update" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="center-page">
                   ...
                   <h3 style="border-bottom: thin solid #008080; font-weight: 700; text-align: center;">update Form<h3>
                  ...
                  <div class="col-xs-11">
                   ...
                   <div class="col-xs-11"><asp:Button ID="btnupdate" class="btn btn-success" runat="server" Text="Update" onclick="btnupdation_Click" Width="125px" /></div>
